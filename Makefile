...
package-extensions: build-extension
	...
	cd artifacts/package/chromium && python3 -m zipfile -c ../../extensions/webviewmcp-chromium.zip manifest.json dist
	cd artifacts/package/firefox && python3 -m zipfile -c ../../extensions/webviewmcp-firefox.zip manifest.json dist
